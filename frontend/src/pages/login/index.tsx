...
const LoginPage = () => {
  ...
  return (
    <main className="flex items-center justify-center h-[100dvh] w-full">
      <Card className="max-h-[calc(100%-2rem)] max-w-[500px] w-full mx-2 px-4 rounded-4xl overflow-y-auto">
        <motion.div
        ...
        >
          {dialogStep === DialogStepsEnum.loading && (
            <CardHeader className="aspect-video flex items-center justify-center w-full">
