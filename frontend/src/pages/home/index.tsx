...
export default memo(function Home() {
  return (
    <main
      ...
      "
    >
      <section className="flex flex-col items-center justify-center h-[55dvh] w-full relative">
...
const GoBoldForm = () => {
  ...
  return (
    ...
    >
      ...
      >
        <section className="text-base rounded-2xl animate-bounce duration-1000 absolute -top-11 -left-10 -rotate-5 bg-inherit p-1 px-2 border">
          Toggle Color
        </section>
        <section className="absolute flex items-center gap-1 top-0 left-0 -translate-y-1/3">
          {[themeEnum.default, themeEnum.black_plum, themeEnum.blue_sky].map(
            (_, idx) => (
              <div
                key={idx}
                className={cn(
                  ...
                  "active:scale-90",
                  { "bg-green-950": _ == themeEnum.default },
                  {
              ...
              >
                ...
                >
                  <Droplet
                    ...
                    className={cn(
                      "",
                      { "text-green-950 ": _ == themeEnum.default },
                      {
